...
<!--Secound container-->
<div class="container details" style="margin-top: 14px">
            ...
            <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="staff_id" id="staff_id" class="form-control ins" readonly>
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="staff_name" id="company_name" class="form-control ins">
                        @error('staff_name')
                    ...
                    <div class="col-md-9 com_in">
                        <select name="warehouse" id="warehouse" class="form-control ins">
                            @foreach($warehouse as $warehouses)
                                <option value="{{ $warehouses->warehouse_code }}">{{ $warehouses->warehouse_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="address" class="form-control ins" value="{{ isset($staff) ? $staff->address : '' }}">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
...
<script>
    ...
    window.onload = function() {
        document.getElementById('staff_id').value = generateVendorCode();
    };
