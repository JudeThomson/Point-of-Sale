            ...
            <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="customer_id" id="customer_id" class="form-control ins" readonly>
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="customer_name" id="company_name" class="form-control ins">
                        @error('customer_name')
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="mobile" id="" class="form-control ins">
                        @error('mobile')
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="address1" class="form-control ins" value="{{ isset($staff) ? $staff->address1 : '' }}">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="address2" class="form-control ins" value="{{ isset($staff) ? $staff->address2 : '' }}">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="address3" class="form-control ins" value="{{ isset($staff) ? $staff->address3 : '' }}">
                    </div>
                </div>
                <!--Other State Here-->
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="email" name="email" id="" class="form-control ins" value="{{ isset($staff) ? $staff->email : '' }}">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="remark" class="form-control ins" value="{{ isset($staff) ? $staff->remark : '' }}">
                    </div>
                </div>
                <div class="row btns">
                    <div class="col-md-6">
