...
<div class="container details">
    <div class="row patrow">
        <div class="col-md-12">
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="upimg">
                            <label for="profile_pic">
                                <img id="preview_image" src= {{ asset('img/gift.png') }}>
                            </label>
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="product_name" id="product_name" class="form-control ins">
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="hsn_code" id="hsn_code" class="form-control ins">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname category">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="unit_of_msrment" id="unit_of_msrment" class="form-control ins">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname category">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="selling_rate" id="selling_rate" class="form-control ins">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname category">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="cgst" id="cgst" class="form-control ins">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname category">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="sgst" id="sgst" class="form-control ins">
                    </div>
                </div>
                ...
                <div class="row com_row">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="igst" id="igst" class="form-control ins">
                    </div>
                </div>
                <div class="row com_row">
                    <div class="col-md-3 patname category">
                    ...
                    <div class="col-md-9 com_in">
                        <input type="text" name="reorder_level" id="reorder_level" class="form-control ins">
                    </div>
                </div>
                <div class="row btns">
                    <div class="col-md-6">
