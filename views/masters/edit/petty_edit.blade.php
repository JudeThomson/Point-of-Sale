...
<!--Secound Container-->
    <div class="container seccon">
        <div class="row patrow">
            <div class="col-md-12">
				<form action="{{ route('petty.update', $petty->_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
					<div class="row com_row">
                        ...
                        <div class="col-md-9 com_in">
                            <input type="text" name="petty_account_code" id="petty_account_code" class="form-control ins" value="{{ $petty->petty_account_code }}" readonly>
                        </div>
                    </div>
                    <div class="row com_row">
                        <div class="col-md-3 patname">
                        ...
                        <div class="col-md-9 com_in">
                            <input type="radio" name="category" value="income" {{ (isset($petty) && $petty->category == 'Income') ? 'checked' : '' }} required> Income
                            <input type="radio" name="category" value="expense" {{ (isset($petty) && $petty->category == 'Expense') ? 'checked' : '' }} required> Expense
                        </div>
                    </div>
                    <div class="row com_row">
                        <div class="col-md-3 patname">
                        ...
                        <div class="col-md-9 com_in">
                            <input type="text" name="petty_account_name" id="petty_account_name" class="form-control ins" value="{{ $petty->petty_account_name }}">
