...
<div class="container seccon">
    <div class="row patrow">
        <div class="col-md-12">
            <input type="text" name="patid" id="inputid_1" class="form-control pat" placeholder=" Staff ID">
            <input type="text" name="patname" id="inputid_2" class="form-control pat" placeholder=" Staff Name">
                ...
                <tbody>
                    @foreach($staff as $staffs)
                        <tr>
                            ...
                            <td class="table_data">
                                <a href="/staff/edit/{{ $staffs->_id }}">
                                    <img src="img/edit.png" alt="edit" style="width: 50px; height: 50px;">
                                </a>
                            </td>
                            <td class="table_data">
                                <img src="img/delete.png" onclick="confirmDelete('{{ $staffs->_id }}')" alt="delete" style="width: 50px; height: 50px;">
                            </td>
                        </tr>
                    @endforeach
                </tbody>
