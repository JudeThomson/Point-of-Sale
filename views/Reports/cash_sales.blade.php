    ...
    <body>
        ...
        <script>
            ...
            async function fetchPurchase() {
                try {
                    const response = await fetch('/cash_sales/data');
                    cash_sales = await response.json();
                    renderTable(cash_sales); 
                } catch (error) {
            ...
            document.getElementById('searchBtn').addEventListener('click', function() {
                ...
                const filteredPurchase = cash_sales.filter(cash => {
                const dateCondition = (!fromDate || !toDate) || (cash.bill_date >= fromDate && cash.bill_date <= toDate);
