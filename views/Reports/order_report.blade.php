    ...
    <body>
        ...
        <script>
            ...
            document.getElementById('searchBtn').addEventListener('click', function() {
                ...
                const filteredPurchase = orders.filter(order => {
                const dateCondition = (!fromDate || !toDate) || (order.date_field >= fromDate && order.date_field <= toDate);
            ...
            function renderTable(data) {
                ...
                data.forEach(order => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${order.date_field}</td>
                        <td>${order.advance || 'N/A'}</td>
                    </td>
                    `;
